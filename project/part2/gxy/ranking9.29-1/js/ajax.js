...
//绑定数据
    bindHtmlA:function bindHtmlA(ele,url){
        ...
        for (let i = 0; i < this.data.products.length; i++) {
           ...
           <div class="proImg"><img src="${cur.imgPath}" alt=""></div>
            ...
            strb1+=`<div class="swiper-slide slider-content page clearfix">
                        <a href="javascript:;">
                            ...
                            <ul class="smallImg3 clearfix">
                                <li><img src="${cur.list[0]}" alt=""></li>
                                <li><img src="${cur.list[1]}" alt=""></li>
                                <li><img src="${cur.list[2]}" alt=""></li>
                            </ul>
            ...
            if(i<3){
                strc1+=` <li class="page-content">
                            <a href="javascript:;">
                                ...
                                <div class="n-left"><img src="${cur.imgUrl}" alt=""></div>
                                <div class="n-mid">
